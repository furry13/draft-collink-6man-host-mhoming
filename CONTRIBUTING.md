...
Discussion of this work occurs on the [IPv6 Maintenance
Working Group mailing list](mailto:ipv6@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/ipv6/),
[subscribe](https://www.ietf.org/mailman/listinfo/ipv6)).
...
[Working Group documents](https://datatracker.ietf.org/wg/6man/documents/).
